...
const CARDS = {
  ...
  /*Baratie*/
  patty: { name: "Patty", series: "One Piece", pack: "baratie", rarity: "Common", image: "./images/baratie/patty.png", coinsPerSecond: 12, resale: 15},
  pearl: { name: "Pearl", series: "One Piece", pack: "baratie", rarity: "Common", image: "./images/baratie/pearl.png", coinsPerSecond: 13, resale: 15},
  ...
  nojiko: { name: "Nojiko", series: "One Piece", pack: "arlongpark", rarity: "Common", image: "./images/arlongpark/nojiko.png", coinsPerSecond: 16, resale: 50},
  choo: { name: "Choo", series: "One Piece", pack: "arlongpark", rarity: "Uncommon", image: "./images/arlongpark/choo.png", coinsPerSecond: 17, resale: 100},
...
const PACK_GROUPS = {
  ...
  "One Piece": {enableViewAll: true,image: "series/onepiecepack.png", packs:{
   ...
   baratie: {name: "Baratie", price: 750, cardsPerPack: 2, series: "One Piece", image: "packs/baratie.png"},
   arlongpark: {name: "Arlong Park", price: 850, cardsPerPack: 2, series: "One Piece", image: "packs/arlongpark.png"}}},
...
function renderShopSeries(seriesName) {
  ...
  Object.entries(group.packs).forEach(([key, pack]) => {
    ...
    div.innerHTML = `
      ...
      <img src="${pack.image}">
      ${isUnlocked
    ? `<button class="shop-button" onclick="openGroupedPack('${seriesName}','${key}')">Buy</button>`
...
document.getElementById("importFile").addEventListener("change", function (event) {
  ...
  reader.onload = e => {
    try {
      ...
      coins = Math.max(coins, data.coins ?? 25);
